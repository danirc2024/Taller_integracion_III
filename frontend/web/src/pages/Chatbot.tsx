...
export default function Chatbot() {
 ...
 <div className="relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full bg-primary dark:bg-primary items-center justify-center">
...
"Busco Harina de Almendras 1kg"
 ...
 className="text-left px-3 py-2 text-sm bg-background hover:bg-primary dark:hover:bg-primary border border-border hover:border-border dark:hover:border-border rounded-xl transition-all duration-200 text-foreground dark:text-foreground hover:text-primary-foreground font-medium"
 >
"{chip}"
 </button>
 ))}
 ...
 <span className={msg.step! > 2 ?"text-foreground": msg.step! === 2 ?"text-foreground dark:text-foreground font-medium":"text-muted-foreground"}>Cruzando stock en supermercados de Temuco...</span>
 </div>
 <div className="flex items-center gap-3 text-sm">
 ...
 <div className="mx-auto w-12 h-12 bg-primary dark:bg-primary rounded-full flex items-center justify-center mb-2">
