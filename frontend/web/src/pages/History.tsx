...
"bg-card rounded-2xl border p-5 shadow-sm transition-all group",
 ...
 list.status === 'out-of-stock' ?"border-border dark:border-border": 
"border-border dark:border-border hover:border-border"
 ...
 <div className="mb-4">
 {list.status === 'fresh' && (
 <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-primary text-primary-foreground text-xs font-bold border-2 border-border shadow-[4px_4px_0px_var(--color-border)]">
 ...
 <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-primary text-primary-foreground text-xs font-bold border-2 border-border shadow-[4px_4px_0px_var(--color-border)] w-fit">
 <AlertCircle className="h-3.5 w-3.5"/> Quiebre de Stock Detectado
 </div>
 <p className="text-xs text-foreground font-bold mt-1 pl-1">
 ...
 {list.status === 'fresh' ? (
 <Link to="/route"className="flex-1 bg-primary hover:bg-primary/90 text-primary-foreground border-2 border-border shadow-[4px_4px_0px_var(--color-border)] py-2.5 rounded-xl font-bold flex justify-center items-center gap-2 transition-colors text-sm border-2 border-border shadow-[4px_4px_0px_var(--color-border)]">
 Ver Ruta
