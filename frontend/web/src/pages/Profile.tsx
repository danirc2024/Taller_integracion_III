...
export default function Profile() {
 ...
 className={cn("flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all", transportMode === 'car' ?"border-border bg-primary text-primary-foreground shadow-[4px_4px_0px_var(--color-border)]-foreground shadow-[4px_4px_0px_var(--color-border)]":"border-border text-muted-foreground hover:border-zinc-300 dark:hover:border-zinc-700")}
 >
 ...
 className={cn("flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all", transportMode === 'bus' ?"border-border bg-primary text-primary-foreground shadow-[4px_4px_0px_var(--color-border)]-foreground shadow-[4px_4px_0px_var(--color-border)]":"border-border text-muted-foreground hover:border-zinc-300 dark:hover:border-zinc-700")}
 >
...
"flex flex-col items-center text-center p-3 rounded-xl border transition-all h-full justify-center",
 diet.includes(d.id) ?"border-border bg-primary text-primary-foreground shadow-[4px_4px_0px_var(--color-border)]-foreground shadow-[4px_4px_0px_var(--color-border)]":"border-border text-muted-foreground hover:bg-accent"
 )}
 >
