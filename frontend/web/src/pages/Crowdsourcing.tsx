...
export default function Crowdsourcing() {
 ...
 className="flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-border text-foreground hover:bg-muted font-bold transition-colors"
 >
 <ThumbsDown className="h-5 w-5"/> No, cambiar
 </button>
 <button
 onClick={() => handleAction(mission.id, 'confirm')}
 className="flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-border bg-primary text-primary-foreground hover:bg-primary/90 font-bold transition-colors shadow-[4px_4px_0px_var(--color-border)]"
 >
 ...
 <div className="flex flex-col items-center justify-center py-6 text-primary dark:text-primary">
