...
_C_ vehículo =<sup></sup> _R_<sup>_× P_combustible</sup>
...
Se recomienda descargar todo lo que son rutas, paraderos, horarios, etc de Temuco en el siguiente link, en el cual se debe descargar un .zip y desde este extraer todos los archivos correspondientes:

[dtpr.gob.cl/pe/temuco/?brx_usuysl=gtfs](https://dtpr.gob.cl/pe/temuco/?brx_usuysl=gtfs)
